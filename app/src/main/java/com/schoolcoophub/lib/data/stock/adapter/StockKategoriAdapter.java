...
public class StockKategoriAdapter extends RecyclerView.Adapter<StockKategoriAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StockViewHolder holder, int position) {
        ...
        if (imageResId != 0) {
            ...
            holder.imageView.setImageResource(R.drawable.placeholder); // Jika tidak ditemukan, gunakan placeholder
        }
        ...
        if (item.getJumlahBarang() == 0) {
            holder.labelKosong.setVisibility(View.VISIBLE);
            holder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.black_opacity_30));
            holder.overlay.setVisibility(View.VISIBLE);
        } else {
            holder.labelKosong.setVisibility(View.GONE);
            holder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.unselected));
    ...
    public class StockViewHolder extends RecyclerView.ViewHolder {
        TextView namaBarangTextView, hargaBarangTextView, jumlahBarangTextView, tvPaket1, labelKosong;
